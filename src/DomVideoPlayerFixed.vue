  ...
  methods: {
    ...
    async checkVideoOrientation() {
      ...
      try {
        ...
        this.videoOrientation = { isLandscape: false }
...
export default {
  ...
  methods: {
    ...
    createFullscreenButton() {
      const { showLandscapeFullscreenButton, videoOrientation } = this.renderProps
	...
	button.innerHTML = '<img src="https://zeno-img.oss-cn-shenzhen.aliyuncs.com/image_17662122424244555d407154f528acd87281c33396fae.png" style="display:block;width:96px;height:30px;">'
	...
	button.style.padding = '5px' // 添加内边距让图片与背景有间距
      ...
      if (wrapper) {
		...
		const { videoOrientation } = this.renderProps
    ...
    updateFullscreenButton() {
      ...
      const { showLandscapeFullscreenButton, videoOrientation, isFullscreen } = this.renderProps
      const isLandscape = videoOrientation?.isLandscape || false
    ...
    triggerLandscapeFullscreen() {
      ...
      const { forceLandscapeFullscreen } = this.renderProps
    ...
    enterLandscapeFullscreen() {
      ...
      videoClone.controls = true // 横屏全屏时显示控件
		...
		exitButton.innerHTML = '<img src="https://zeno-img.oss-cn-shenzhen.aliyuncs.com/image_17662199265742063c6b1214e62c83fef7db2832faa03.png" alt="退出全屏" />'
